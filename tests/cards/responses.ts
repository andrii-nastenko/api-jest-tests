...
export function checkCardResponse(data?: PartialDeep<CardResponse>): jest.Expect {
  return expect.objectContaining({
    ...
    badges:
      data?.badges != null
        ? expect.objectContaining({
            attachmentsByType:
              data?.badges?.attachmentsByType != null
                ? expect.objectContaining({
                    trello:
                      data?.badges?.attachmentsByType?.trello != null
                        ? expect.objectContaining({
                            board:
        ...
        : expect.any(Object),
    checkItemStates:
      data?.checkItemStates != null ? data?.checkItemStates : expect.any(Array),
    ...
    idChecklists: data?.idChecklists != null ? data?.idChecklists : expect.any(Array),
    idList: data?.idList ?? expect.any(String),
    idMembers: data?.idMembers != null ? data?.idMembers : expect.any(Array),
    idMembersVoted:
      data?.idMembersVoted != null ? data?.idMembersVoted : expect.any(Array),
    idShort: data?.idShort ?? expect.any(Number),
    idAttachmentCover:
      data?.idAttachmentCover ?? expect.toBeOneOf([null, String, Number]),
    labels: data?.labels != null ? data?.labels : expect.any(Array),
    idLabels: data?.idLabels != null ? data?.idLabels : expect.any(Array),
      ...
      data?.cover != null
        ? expect.objectContaining({
            ...
            idUploadedBackground:
              data?.cover?.idUploadedBackground ??
              expect.toBeOneOf([null, String, Number]),
